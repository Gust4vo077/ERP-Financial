  ...
  <>
    ...
    <div className="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
      ...
      <a href="https://github.com/themesberg/flowbite-admin-dashboard" target="_blank" className="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
          ...
          <span className="ml-3" sidebar-toggle-item>GitHub </span>
        </a>
        ...
        <a href="https://github.com/themesberg/flowbite-admin-dashboard/issues" target="_blank" className="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
          <svg className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-2 0c0 .993-.241 1.929-.668 2.754l-1.524-1.525a3.997 3.997 0 00.078-2.183l1.562-1.562C15.802 8.249 16 9.1 16 10zm-5.165 3.913l1.58 1.58A5.98 5.98 0 019.127 18c-2.14 0-4.045-1.098-5.128-2.739l1.58-1.58a3.978 3.978 0 004.689-.349zm-4.307-1.75l-1.98 1.979c-.526-.752-.826-1.632-.826-2.596 0-.246.022-.487.058-.724l1.518-1.517c.084.041.168.089.25.129 1.393.568 2.865.312 3.871-.693l1.672 1.672a4.003 4.003 0 00-.133 4.708zM9.953 9.57c.12.081.226.174.33.284l1.72 1.72c.119-.053.243-.092.377-.092a2 2 0 110 4c-.017 0-.035-.004-.052-.004l-1.593-1.593a1.982 1.982 0 01-.02-1.375z" clipRule="evenodd" />
          </svg>
          <span className="ml-3" sidebar-toggle-item>Issues</span>
        </a>
